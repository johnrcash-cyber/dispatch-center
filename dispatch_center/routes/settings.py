...
def save_setting(setting):
    ...
    setting.login_url = form_text(request.form, "login_url")
    setting.username = form_text(request.form, "username")
    setting.password = form_text(request.form, "password")
    setting.recovery_email = form_text(request.form, "recovery_email")
    setting.two_factor_notes = form_text(request.form, "two_factor_notes")
    setting.credential_notes = form_text(request.form, "credential_notes")
